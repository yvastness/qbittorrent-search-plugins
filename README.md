...
> 一个专为 qBittorrent 开发的适配 2026 年网站最新结构的搜索插件集合。

### 安装方法

1. **启用插件**
   - 打开 qBittorrent → **视图 → 搜索**
   - 在搜索界面右上角点击 **搜索插件** → 点击 **安装新插件**
2. **选择需要的插件**
...
1. 打开 qBittorrent 的搜索功能
2. 在搜索框输入关键词，例如：
   - `linux`
   - `windows11`
3. 点击 **搜索**

插件会自动抓取结果并以 magnet 链接形式添加到 qBittorrent。

### 注意事项

- 搜索结果依赖网站本身的可用性，如果网站改版可能需要更新插件
